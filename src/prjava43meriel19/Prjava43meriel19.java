...
public class Prjava43meriel19 extends Frame 
   ...
   public Prjava43meriel19 () { 
      ...
      setTitle("nova finestra prjava43meriel19");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43meriel19();  // Let the construct do the job 
   } 
